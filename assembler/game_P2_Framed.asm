...
LOCAL_MOVE:
	...
	LOADLBL G_PREVIOUS_SENT R9
	LOADLBL G_LAST_SENT R10
	LOAD R10 R11
	STORE R9 R11
	LOADLBL G_FRAME_COUNTER R6
	LOAD R6 R7
	LOADLBL G_FRAME_OFFSET R8
	LOAD R8 R8
	ADD R8 R7
	STORE R6 R7
	...
	# adding the frame counter to the upper bits
	OR R5 R0
	STORE R10 R0
	WRITESERIAL R0
...
REMOTE_RESEND:
	LOADLBL G_LAST_SENT R0
	LOAD R0 R0
	WRITESERIAL R0
	NOP 
	LOADLBL G_PREVIOUS_SENT R0
	LOAD R0 R0
	WRITESERIAL R0
	CLOCK R8
	ADDI 200 R9
...
# frame counter
G_FRAME_COUNTER: .fill 0x0000
G_FRAME_OFFSET: .fill 0x0100
G_LAST_SENT: .fill 0x0000
