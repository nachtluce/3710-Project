...
int GetOpCode(char *op)
{
  ...
  RETURN_OP_MATCH( BGEU_STR,  BGEU_OPCODE );
  RETURN_OP_MATCH( BEQ_STR, BEQ_OPCODE );
  RETURN_OP_MATCH( BL_STR, BL_OPCODE );
  RETURN_OP_MATCH( BLU_STR, BLU_OPCODE );
  RETURN_OP_MATCH( JGE_STR,   JGE_OPCODE );
  RETURN_OP_MATCH( JGEU_STR,  JGEU_OPCODE );
  RETURN_OP_MATCH( JEQ_STR, JEQ_OPCODE );
  RETURN_OP_MATCH( JL_STR, JL_OPCODE );
  RETURN_OP_MATCH( JLU_STR, JLU_OPCODE );  
...
int GetOpExt(char *op)
{
  ...
  RETURN_OP_MATCH( BGEU_STR,  BGEU_OPEXT );
  RETURN_OP_MATCH( BEQ_STR, BEQ_OPEXT );
  RETURN_OP_MATCH( BL_STR, BL_OPEXT );
  RETURN_OP_MATCH( BLU_STR, BLU_OPEXT );
  RETURN_OP_MATCH( JGE_STR,   JGE_OPEXT );
  RETURN_OP_MATCH( JGEU_STR,  JGEU_OPEXT );
